    ...
    return (
        <div className='bg-[#244D3F] pt-15 '>
            <div className="max-w-11/12 mx-auto">
                ...
                <h3 className='text-center text-white mt-7 text-xl font-bold'>Social Links</h3>
                ...
                <div className="border-t pt-8 pb-5 mt-13 border-[#ffffff30] md:flex justify-between items-center">
                    <p className='text-white text-center md:text-start'>© 2026 KeenKeeper. All rights reserved.</p>
                    <ul className='flex gap-3 justify-center md:justify-start text-white mt-5 md:mt-0'>
